...
public interface IRemainTableRepo extends JpaRepository<DummyEntity, Long> {
    @Query(value = """
            ...
            (
                ...
                FROM exl
                INNER JOIN MANUFASPCPD.dbo.MANUFA_F_PD_DT_ORDER_DTL dtl
                    ON exl.VBELN = dtl.VBELN
            ...
            (
                ...
                INNER JOIN MANUFASPCPD.dbo.MANUFA_F_PD_DT_REQ_HED hed
                    ON rec.OrderNo = hed.AUFNR
            
                INNER JOIN exl
                    ON hed.KDAUF = exl.VBELN
            ...
            LEFT JOIN F2_Cus_Grp cus
                ON check_fn.CusID = cus.CusID
